...
<head>
    ...
    <title>The Pool Champs | Pool Construction | Pool Maintenance | In Pretoria | In Johannesburg | In Gauteng</title>
...
<body>
    <?php
    // Defining a PHP variable
    $company = "Pool Champs";
    $tel = "082 200 8760";
    $email = "info@thepoolchamps.co.za";
    ?>
            ...
            <div class="container">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 service-item">
                        ...
                        <p class="service-description">Pool Champs is equipped to meet all your plumbing needs. We provide the highest quality services at competitive prices with prompt, professional and friendly service.
                        </p>
                    </div>
                    <div class="col-lg-4 col-md-6 service-item">
                        <div class="service-icon"><i class="bi bi-brightness-high"></i></div>
            ...
            <div class="container" data-aos="fade-up">
                <div class="row">
                    ...
                    <div class="col-md-4 subscribe-btn-container">
                        <a class="subscribe-btn" href="tel:082 200 8760">Call us now</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="testimonials">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="quote">
                            <b><img src="assets/img/quote_sign_left.png" alt=""></b> What a great friendly team, we are just super happy with the fibre lining work done and we cannot recommend the Pool Champs enough! . <small><img src="assets/img/quote_sign_right.png" alt=""></small>
                        </div>
                    </div>
                </div>
